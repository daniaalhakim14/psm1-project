...
class ExpenseCategories {
  ...
  factory ExpenseCategories.fromJson(Map<String, dynamic> json) => ExpenseCategories(
    categoryId: json['categoryid'] is int ? json['categoryid'] : int.tryParse(json['categoryid'].toString()) ?? 0, // Safely parse categoryid
